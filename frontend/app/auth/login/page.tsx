...
import { useLoginUserMutation } from "@/app/admin/services/userApi";
    ...
    const formik = useFormik({
        ...
        onSubmit: async (values, action) => {
            ...
            try {
                ...
                const redirectPath = rolePaths[data.user.role] ?? "/unauthorized";
                ...
                setServerErrorMessage(err?.data?.message || "Invalid email or password");
            }
        },
    });
...
return (
    <div className="flex h-screen bg-black text-white p-4">
        ...
        <div className="hidden relative lg:flex w-2/3 flex-col items-center justify-center p-12 bg-gradient-to-b from-purple-500 to-black rounded-t-3xl grid-lines  ">
            <h2 className="text-3xl font-bold mb-3">Arun</h2>
