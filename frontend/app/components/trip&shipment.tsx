// // app/components/TripsAndShipments.tsx
// "use client";

// import { useState } from "react";
// import { useGetTripsByTimeQuery } from "@/app/services/tripApi";
// import { useGetShipmentByTimeQuery } from "@/app/services/shipmentApi"; // adjust path
...
import { useGetTripsByTimeQuery } from "@/app/services/tripApi";
import { useGetShipmentByTimeQuery } from "@/app/services/shipmentApi";
...
export default function TripsAndShipments({
  ...
  const handleCreateClick = () => {
    if (activeTab === "trips") {
      router.push("/trips/add-trip");
    } else {
      router.push("/shipments/add-shipment");
    }
  };
    ...
    <div className="w-full max-w-6xl mx-auto p-4 sm:p-6 hover:shadow-primary/20 transform hover:-translate-y-0.5 transition-all duration-300">
      ...
      <div className="flex justify-between items-center mb-6">
        ...
        <button
          ...
          // title="home"
          className="btn bg-base-100 hover:bg-primary/10 rounded-3xl  transition-all"
