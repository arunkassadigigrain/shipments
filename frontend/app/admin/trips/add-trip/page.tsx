...
import { useCreateTripMutation } from "@/app/admin/services/tripApi";
...
import { useGetAllCreatedQuery } from "@/app/admin/services/shipmentApi";
...
export default function AddTrip() {
  ...
  const [createTrip, { isLoading: isSubmitting, isError, error }] =
              ...
              <div className="card-body p-6 md:p-8">
                <form className="space-y-8" onSubmit={handleSubmit}>
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div className="form-control">
                          ...
                          <input
                            ...
                            readOnly
                            className="input input-bordered sm:w-[500px] md:w-[480px] lg:w-[500px] rounded-2xl bg-neutral/10 text-base-content/70 border-base-300 cursor-not-allowed outline-none transition-all duration-300"
                          />
                        </div>
                      </div>
                    </div>
                  ...
                  <div className="flex justify-end gap-4 ">
                    ...
                    <button
                      type="button"
                      className="btn btn-ghost rounded-2xl w-44 border border-base-300 hover:border-primary/50 hover:bg-primary/5 transition-all duration-300 font-medium"
                      disabled={isSubmitting}
                      onClick={clearAll}
                    >
                      Clear
